        ...
        edit: function ( props ) {
            ...
            return createElement(RichTextToolbarButton, {
                ...
                onClick:function(){
                    let ruby = '';
                    if ( ! isActive ) {
                        ruby = window.prompt( __( 'Ruby注音', 'wppy-nihao' ) ) || value.text.substr( value.start, value.end -value.start );
                ...
                icon: createElement('img', { src: assets.url+'/images/wppy.svg', style: { width:'16px',margin: '2px 6px 0 2px' } }),
                isActive: isActive,
